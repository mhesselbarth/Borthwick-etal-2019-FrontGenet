...
df_lcp <- tibble::tibble(site_1 = site_ids$site_1, 
  ...
  dplyr::left_join(dps, by = c("site_1", "site_2"))
...
model_dredge_lcp <- modular_function(response = "DPS", 
...
r2_lcp <- modular_function(response = "DPS", 
                           explanatory = "least_cost",
                           random = "(1|site_1)",
                           data = df_lcp,
                           ZZ = ZZ_matrix, 
...
# resistance model
model_dredge_res <- modular_function(response = "DPS", 
...
r2_res <- modular_function(response = "DPS", 
                           explanatory = "resistance_scaled", 
                           random = "(1|site_1)",
                           data = df_res,
                           ZZ = ZZ_matrix,
